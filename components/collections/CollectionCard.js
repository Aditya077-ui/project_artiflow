            ...
            <div className='bg-slate-800 rounded-lg'>
                ...
                <div className='relative flex flex-col space-y-2 justify-center p-4 bg-gradient-to-r from-fuchsia-600/40 to-pink-600/40 rounded-lg'>
                    ...
                    <div className='h-40 w-full rounded-md overflow-hidden'>
                        <Image src={nfts[0]} alt='nft' className='' />
                    </div>
                    {/* 3 NFTs */}
                    <div className='grid grid-cols-3 gap-2'>
                        <Image src={nfts[1]} alt='nft' className='rounded-md' />
                        <Image src={nfts[2]} alt='nft' className='rounded-md' />
                        <Image src={nfts[3]} alt='nft' className='rounded-md' />
                    </div>
                    {/* Profile */}
